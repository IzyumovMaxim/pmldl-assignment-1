...
Результат проверенного запуска на фиксированном test split: ROC-AUC `0.8737`, Average Precision `0.6031`, Brier score `0.0921`, F1 `0.5877`, recall `0.6657`. Дисбаланс учтён весом положительного класса `5.204`, вероятности калибруются sigmoid-калибровкой на трёх фолдах, а порог `0.275` выбран только на validation-части train-набора.
